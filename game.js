class Game {
  ...
  correctAnswerSubmitted() {
    ...
    if (this.turn === "player1") {
      var img = '<img src="https://zuzkanovakova.github.io/JSFunctionMaster/images/ironhack_blue.png" height="50" width="45">';
    ...
    if (this.turn === "player2") {
      ...
      var img = '<img src="https://zuzkanovakova.github.io/JSFunctionMaster/images/ironhack_black.png" height="50" width="45">';
      this.hexaButtonsArray[this.buttonPressed.id].innerHTML = img;
      this.hexaButtonsArray[this.buttonPressed.id].style.backgroundColor = "white";
